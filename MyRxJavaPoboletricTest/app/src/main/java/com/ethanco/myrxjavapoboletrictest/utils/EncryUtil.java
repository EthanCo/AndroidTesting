package com.ethanco.myrxjavapoboletrictest.utils;
...
/**
 * Created by qiukeling on 2016/6/7.
 */
public class EncryUtil {
     ...
     * @return
     */
    public static Bundle getSignStr(Bundle map) {
        if (map != null) {
